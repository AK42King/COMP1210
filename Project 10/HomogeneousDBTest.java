...
public class HomogeneousDBTest {
   ...
   @Test public void costFactorTest1() {
      HomogeneousDB db1 = new HomogeneousDB("Database Two", 2000.0, 
         7.5, 100, 12.0);
      Assert.assertEquals(1.2, db1.getCostFactor(), 0.001);
   }
   /**
    * tests license.
    */
   @Test public void monthlyCostTest1() {
      HomogeneousDB db1 = new HomogeneousDB("Database Two", 2000.0, 
         7.5, 100, 12.0);
      Assert.assertEquals(3440.0, db1.monthlyCost(), 0.001);
   }
   /**
   * tests license.
   */
